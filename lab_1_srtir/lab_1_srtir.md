...
2. **[Задача №111157. Сортировка вставкой](task2_binary_search.cpp)**  
...
3. **[Задача №111158. Сортировка пузырьком](task3_stack.cpp)**  
...
4. **[Задача №1411. Сортировка пузырьком](task4_queue.cpp)**  
...
5. **[Задача №766. Сортировка слиянием](task5_insertion_sort.cpp)**  
...
6. **[Задача №733. Быстрая сортировка](task6_bubble_sort.cpp)**  
...
7. **[Задача №111166. Сортировка подсчетом](task7_merge_sort.cpp)**  
...
8. **[Задача №325. Сортировка точек](task8_quick_sort.cpp)**  
